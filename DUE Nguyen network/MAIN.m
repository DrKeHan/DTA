...
alpha=70;  % time step size of the fixed point algorithm; this measures drivers' sensitivity to the travel costs
processedDataFile = [cd, '/Nguyen24_pp.mat']; % file path to the pre-processed network file
