...
alpha=150;  % time step size of the fixed point algorithm; this measures drivers' sensitivity to the travel costs
processedDataFile = [cd, '/Braess8_pp.mat']; % file path to the pre-processed network file
%% Load relevant data
