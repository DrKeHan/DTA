...
threshold=0.0001;   % Convergence threshold for the DUE algorithm
...
alpha=20;  % time step size of the fixed point algorithm; this measures drivers' sensitivity to the travel costs
processedDataFile = [cd, '/SiouxFalls6180_pp.mat']; % file path to the pre-processed network file
